...
if (!$('body').hasClass('moto-preview')) {
    $(document).ready(function() {
        ...
        function detectBrowser() {
            ...
            window.document.body.classList.add('moto-browser_' + browser);
        }
        ...
        function(MotoStorageService) {
            return {
                ...
                link: function($scope, $element) {
                    ...
                    $scope.closeNotification = function(event, daysToExpire) {
...
/* Source: src/mt-includes/widgets/pagination/src/common/PaginatorClass.js*/
angular.module('common.elements.Paginator', []).service('common.elements.PaginatorClass', [
    function() {

        function PageItemClass(value, number) {
            this.value = value;
            this.number = angular.isNumber(number) ? number : null;
         ...
         */
        function transformItem(item, number) {
        ...
        function transformItems(items) {
            ...
            for (i = 0, len = items.length; i < len; i++) {
                result.push(transformItem(items[i], i + 1));
            }
        ...
        PaginatorClass.prototype = {
            ...
            setData: function(data) {
                ...
                this.firstNumber = 1;
                this.first = this.getFirstPage() || new PageItemClass(null, 1);
                this.last = this.getLastPage() || new PageItemClass(null, this.pageCount + 1);
            ...
            setCurrentPageNumber: function(number) {
                ...
                this.previous = this.getPreviousPage() || new PageItemClass(null, this.previousNumber);
                this.current = this.getCurrentPage() || new PageItemClass(null, this.currentNumber);
                this.next = this.getNextPage() || new PageItemClass(null, this.nextNumber);
                this.updatePagesInRange();
